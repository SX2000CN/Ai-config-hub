...
| pencil-design-workflow | active | `skills/shared/pencil-design-workflow/` | `skills/claude-code/pencil-design-workflow/SKILL.md` | `skills/codex/pencil-design-workflow/SKILL.md` | 本仓库维护并渲染到用户级目录的全局 Pencil / .pen / pencli 设计先行路由 skill；进入真实前端实现后衔接 `global-frontend-design`。 |
