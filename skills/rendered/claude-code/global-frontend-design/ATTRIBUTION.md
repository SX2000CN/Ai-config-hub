...
上游来源、许可证核验结果和下载失败记录已归档到 `docs/ai/archive/global-frontend-design-sources/`。为降低公开再分发风险，该归档不保存 Anthropic 官方 skill 的完整原文。
...
- 目标记录文件：`docs/ai/archive/global-frontend-design-sources/anthropic-frontend-design-SKILL.md`
...
- 目标记录文件：`docs/ai/archive/global-frontend-design-sources/frontend-ui-design-SKILL.md`
