...
description: 创建、重设计或审查前端界面时，先建立鲜明的产品化视觉方向，再用现有前端技术栈落地可维护、可访问、响应式且状态完整的 UI。
when_to_use: 用户要创建、修改、重设计或 review 前端页面、组件、仪表盘、表单、落地页、布局、React/Vue/Svelte/HTML/CSS、Tailwind/shadcn 风格 UI，或要求提升视觉质量、可访问性、响应式和状态覆盖时使用。
---
