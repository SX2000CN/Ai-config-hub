...
| Skill | 状态 | Canonical 事实源 | Claude Code 入口 | Codex 入口 | 备注 |
|---|---|---|---|---|---|
...
- `.claude/skills/<skill-name>/SKILL.md`、`.agents/skills/<skill-name>/SKILL.md` 和可选 `.codex/skills/<skill-name>/SKILL.md` 只作为工具入口或兼容入口。
