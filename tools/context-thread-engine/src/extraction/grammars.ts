...
/**
 * Whether a file is one ContextThread can parse, based purely on its extension.
...
export async function loadGrammarsForLanguages(languages: Language[]): Promise<void> {
  ...
  for (const lang of toLoad) {
    ...
    try {
      ...
      console.warn(`[ContextThread] Failed to load ${lang} grammar — parsing will be unavailable: ${message}`);
