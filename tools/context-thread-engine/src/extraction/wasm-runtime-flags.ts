 ...
 */
const RELAUNCH_GUARD_ENV = 'CONTEXT_THREAD_WASM_RELAUNCHED';
 ...
 */
export const HOST_PPID_ENV = 'CONTEXT_THREAD_HOST_PPID';
 ...
 * disabled via CONTEXT_THREAD_NO_RELAUNCH.
 *
...
export function relaunchWithWasmRuntimeFlagsIfNeeded(scriptPath: string): void {
  ...
  if (process.env.CONTEXT_THREAD_NO_RELAUNCH) return;
